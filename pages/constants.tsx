...
export const woodwindFingerings: {
  ...
  [WoodwindInstrument.FLUTE]: {
    ...
    [Notes.B4]: [
      [FluteKeys.THUMB_B, FluteKeys.LEFT_FIRST_FINGER, FluteKeys.Eb],
    ],
    ...
    [Notes.Bb6]: [
      [FluteKeys.THUMB_B, FluteKeys.RIGHT_FIRST_FINGER, FluteKeys.D_TRILL],
    ],
    [Notes.B6]: [
      [
        FluteKeys.THUMB_B,
  ...
  [WoodwindInstrument.SAXOPHONE]: {
    ...
    [Notes.A4]: [
      [SaxophoneKeys.LEFT_FIRST_FINGER, SaxophoneKeys.LEFT_SECOND_FINGER],
    ],
    [Notes.Bb4]: [
      [
        SaxophoneKeys.LEFT_FIRST_FINGER,
    ...
    [Notes.Eb6]: [
      [SaxophoneKeys.OCTAVE, SaxophoneKeys.D_PALM, SaxophoneKeys.Eb_PALM],
    ],
    [Notes.E6]: [
      [
        SaxophoneKeys.OCTAVE,
  ...
  [BrassInstrument.FRENCH_HORN]: {
    [Notes.F3]: [[FrenchHornValves.FIRST]],
    [Notes.Gb3]: [
      [FrenchHornValves.SECOND],
      [FrenchHornValves.FIRST, FrenchHornValves.SECOND, FrenchHornValves.THIRD],
    ],
    [Notes.G3]: [[], [FrenchHornValves.FIRST, FrenchHornValves.THIRD]],
    [Notes.Ab3]: [[FrenchHornValves.SECOND, FrenchHornValves.THIRD]],
    [Notes.A3]: [[FrenchHornValves.FIRST, FrenchHornValves.SECOND]],
    [Notes.Bb3]: [[FrenchHornValves.FIRST]],
    [Notes.B3]: [[FrenchHornValves.SECOND]],
    [Notes.C4]: [[]],
    [Notes.Db4]: [
      [FrenchHornValves.FIRST, FrenchHornValves.SECOND],
      [FrenchHornValves.SECOND, FrenchHornValves.THIRD],
    ],
    [Notes.D4]: [
      [FrenchHornValves.FIRST],
      [FrenchHornValves.FIRST, FrenchHornValves.SECOND],
    ],
    [Notes.Eb4]: [[FrenchHornValves.SECOND], [FrenchHornValves.FIRST]],
    [Notes.E4]: [[], [FrenchHornValves.SECOND]],
    [Notes.F4]: [[FrenchHornValves.FIRST], []],
    [Notes.Gb4]: [
      [FrenchHornValves.SECOND],
      [FrenchHornValves.FIRST, FrenchHornValves.SECOND],
    ],
    [Notes.G4]: [[], [FrenchHornValves.FIRST]],
    [Notes.Ab4]: [[FrenchHornValves.SECOND, FrenchHornValves.THIRD]],
    [Notes.A4]: [[FrenchHornValves.FIRST, FrenchHornValves.SECOND]],
    [Notes.Bb4]: [[FrenchHornValves.FIRST]],
    [Notes.B4]: [[FrenchHornValves.SECOND]],
    [Notes.C5]: [[]],
    [Notes.Db5]: [[FrenchHornValves.SECOND]],
    [Notes.D5]: [[]],
    [Notes.Eb5]: [[FrenchHornValves.SECOND]],
    [Notes.E5]: [[]],
    [Notes.F5]: [[FrenchHornValves.FIRST]],
    [Notes.Gb5]: [[FrenchHornValves.SECOND]],
    [Notes.G5]: [[]],
    [Notes.Ab5]: [[FrenchHornValves.SECOND, FrenchHornValves.THIRD]],
    [Notes.A5]: [[FrenchHornValves.FIRST, FrenchHornValves.SECOND]],
    [Notes.Bb5]: [[FrenchHornValves.FIRST]],
    [Notes.B5]: [[FrenchHornValves.SECOND]],
    [Notes.C6]: [[]],
  },
  [BrassInstrument.TROMBONE]: {
    [Notes.E2]: [
  ...
  [BrassInstrument.FRENCH_HORN]: [
    {
      ...
      fingerings: {
        ...
        [Notes.Ab4]: [
          [
            FrenchHornValves.TRIGGER,
            FrenchHornValves.SECOND,
            FrenchHornValves.THIRD,
          ],
        ],
        [Notes.A4]: [
          [
        ...
        [Notes.Bb4]: [[FrenchHornValves.TRIGGER, FrenchHornValves.FIRST]],
        [Notes.B4]: [[FrenchHornValves.TRIGGER, FrenchHornValves.SECOND]],
        [Notes.C5]: [[FrenchHornValves.TRIGGER]],
        [Notes.Db5]: [
          [
            FrenchHornValves.TRIGGER,
            FrenchHornValves.SECOND,
        ...
        [Notes.Eb5]: [[FrenchHornValves.TRIGGER, FrenchHornValves.FIRST]],
        [Notes.E5]: [[FrenchHornValves.TRIGGER, FrenchHornValves.SECOND]],
        [Notes.F5]: [[FrenchHornValves.TRIGGER]],
        [Notes.Gb5]: [[FrenchHornValves.TRIGGER, FrenchHornValves.SECOND]],
        [Notes.G5]: [[FrenchHornValves.TRIGGER]],
        [Notes.Ab5]: [
          [
            FrenchHornValves.TRIGGER,
            FrenchHornValves.SECOND,
        ...
        [Notes.Bb5]: [[FrenchHornValves.TRIGGER, FrenchHornValves.FIRST]],
        [Notes.B5]: [[FrenchHornValves.TRIGGER, FrenchHornValves.SECOND]],
        [Notes.C6]: [[FrenchHornValves.TRIGGER]],
      },
    },
  ],
  // [BrassInstrument.TROMBONE]: { type: Toggle.TRIGGER, fingerings: [] },
  // [BrassInstrument.TUBA]: { type: Toggle.FOURTH_VALVE, fingerings: [] },
};
